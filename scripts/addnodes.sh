...
ansible-playbook manage.create.nodes.yml -i inventory/digital_ocean.py
ansible-playbook manage.join.nodes.yml -i inventory/digital_ocean.py -e ansible_user=$1